...
import star_3 from "./images/Star_3.png";
const Landing_Page = () => {
    return (
        <div className="landing">
            <div className="star_box_person_image">
                {/* <svg className="star-1" width="365" height="372" viewBox="0 0 365 372" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <img className="star-3" src={star_3} alt="Person" />
