    ...
    return (
      <div className="product_1">
        <div className="product_image">
          ...
          <img className="product_photo" src={image} alt="Product" />
        </div>
        <div className="product_description">
          <span className="desc_1">{title}</span>
          <span className="desc_2">{description}</span>
          <span className="desc_3">${price}</span>
        </div>
      </div>
    );
  }
